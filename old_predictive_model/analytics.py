...
class AssetPredictiveEngine:
    def __init__(self):
        ...
        self.thresholds = {
            "CNC Milling Machine": {
                "temperature": {"warn": 38.0, "critical": 45.0},  # °C
                "vibration": {"warn": 5.0, "critical": 8.0},      # mm/s (ISO 10816)
                "pressure": {"warn": 110.0, "critical": 140.0},   # PSI / hydraulic feed
                "current": {"warn": 50.0, "critical": 65.0}      # Amps
            },
            "Robotic Arm": {
                "temperature": {"warn": 35.0, "critical": 42.0},
                "vibration": {"warn": 4.0, "critical": 6.5},
                "pressure": {"warn": 52.0, "critical": 70.0},
                "current": {"warn": 24.0, "critical": 30.0}
            },
            "Hydraulic Press": {
                "temperature": {"warn": 70.0, "critical": 85.0},
                "vibration": {"warn": 6.0, "critical": 9.0},
                "pressure": {"warn": 250.0, "critical": 300.0},
                "current": {"warn": 80.0, "critical": 95.0}
            }
        }
